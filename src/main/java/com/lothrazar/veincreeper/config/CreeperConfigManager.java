...
public class CreeperConfigManager {

//  public static final ModConfigSpec CONFIG;
//  public static final ConfigValue<List<? extends String>> ENTITIES;
//  public static final BooleanValue SPAWN_EGGS;
//  //default entities
//  private static final List<String> DFLT = Arrays.asList(
//      "coal_creeper,#281414,Coal,true,false,2.2,false",
//      "iron_creeper,#823C14,Iron,true,false,2.2,false",
//      "diamond_creeper,#39ADFA,Diamond,true,false,2.2,false",
//      "copper_creeper,#f06d02,Copper,true,false,2.3,false",
//      "gold_creeper,#F0F000,Gold,true,false,2.5,false",
//      "redstone_creeper,#EB2300,Redstone,false,false,2.5,false",
...
//        var fire = Boolean.parseBoolean(arr[6]);
////        CreeperRegistry.CREEPERS.put(id, new VeinCreeperType(id, c, displayName, exp, isDestructive, rad, fire));
//      }
//      catch (Exception e) {
